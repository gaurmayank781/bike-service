...
import in.co.online.bike.service.exception.RecordNotFoundException;
import in.co.online.bike.service.util.EmailBuilder;
import in.co.online.bike.service.util.EmailMessage;
import in.co.online.bike.service.util.EmailUtility;
	...
	public UserBean findByLogin(String login) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setServiceType(rs.getString(11));
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE B_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,MOBILENO=?,"
					+ "address=?,pincode=?,city=?,state=?,servicetype=?,"
			...
			pstmt.setString(9,bean.getState());
			pstmt.setString(10,bean.getServiceType());
